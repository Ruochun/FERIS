...
int main() {
    const std::string output_dir = "beam_linear_static_t4";
    ...
    // Write output VTK
    // -----------------------------------------------------------------------
    const std::string output_vtk = output_dir + "/output_beam_linear_static_t4.vtk";
    ANCFCPUUtils::WriteFEAT4ToVTK(output_vtk, nodes, elements, x_cur, y_cur, z_cur);
