...
// ---------------------------------------------------------------------------
// ldpm_tet4_cusatis_traction (LEGACY — kept for backward compatibility)
//
// Simplified tensile-shear damage constitutive law (original FERIS model).
// Used when the full LDPM parameter set is not provided.
// ---------------------------------------------------------------------------
