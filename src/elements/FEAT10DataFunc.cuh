...
#pragma unroll
    for (int node = 0; node < 10; node++) {
        ...
        x_nodes[node][0] = d_data->x_cur()(global_node_idx);  // x coordinate
        x_nodes[node][1] = d_data->y_cur()(global_node_idx);  // y coordinate
        x_nodes[node][2] = d_data->z_cur()(global_node_idx);  // z coordinate
    }
