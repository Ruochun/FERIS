...
struct GPU_FEAT4_Data : public ElementBase {
    ...
    void RetrieveInternalForceToCPU(VectorReal3& internal_force) {
        ...
        if (!UnflattenVectorReal3(flat, internal_force)) {
            MOPHI_ERROR("GPU_FEAT4_Data::RetrieveInternalForceToCPU: internal force size (%d) is not divisible by 3.",
    ...
    void RetrieveExternalForceToCPU(VectorReal3& external_force) {
        ...
        if (!UnflattenVectorReal3(flat, external_force)) {
            MOPHI_ERROR("GPU_FEAT4_Data::RetrieveExternalForceToCPU: external force size (%d) is not divisible by 3.",
                        static_cast<int>(flat.size()));
            return;
        }
    }
